...
-- ldbanno -n VHDL -o dft_impl1_vho.vho -w -neg -gui -msgset C:/Users/mohammad/Documents/FPGA/DFT/promote.xml dft_impl1.ncd 
-- Netlist created on Tue Jun 23 11:13:09 2020
-- Netlist written on Tue Jun 23 11:14:00 2020
  ...
  begin
    ...
    SLICE_1I: SCCU2C
      generic map (CCU2_INJECT1_0=>"NO", INIT0_INITVAL=>X"500C", 
                   INIT1_INITVAL=>X"C005")
      port map (M1=>'X', A1=>'1', B1=>baudcounter_0, C1=>'1', D1=>'1', 
    ...
    SLICE_2I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   ...
                   INIT0_INITVAL=>X"C005", INIT1_INITVAL=>X"C005", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'1', B1=>baudcounter_2, C1=>'1', D1=>'1', 
                DI1=>un2_baudcounter_1_cry_1_0_S1, 
                DI0=>un2_baudcounter_1_cry_1_0_S0, A0=>'1', B0=>baudcounter_1, 
    ...
    SLICE_3I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", SRMODE=>"ASYNC", 
                   INIT0_INITVAL=>X"C005", INIT1_INITVAL=>X"A003", 
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>baudcounter_4, B1=>'1', C1=>'1', D1=>'1', 
                DI1=>un2_baudcounter_1_cry_3_0_S1, 
                DI0=>un2_baudcounter_1_cry_3_0_S0, A0=>'1', B0=>baudcounter_3, 
    ...
    SLICE_4I: SCCU2C
      ...
      port map (M1=>'X', A1=>baudcounter_6, B1=>'1', C1=>'1', D1=>'1', 
                ...
                DI0=>un2_baudcounter_1_cry_5_0_S0, A0=>'1', B0=>baudcounter_5, 
    ...
    SLICE_5I: SCCU2C
      ...
      port map (M1=>'X', A1=>baudcounter_8, B1=>'1', C1=>'1', D1=>'1', 
                DI1=>'X', DI0=>un2_baudcounter_1_cry_7_0_S0, A0=>'1', 
                B0=>baudcounter_7, C0=>'1', D0=>'1', 
                FCI=>un2_baudcounter_1_cry_6, M0=>'X', CE=>'X', CLK=>clk, 
                LSR=>'X', FCO=>un2_baudcounter_1_cry_8, 
                F1=>un2_baudcounter_1_cry_7_0_S1, Q1=>open, 
                F0=>un2_baudcounter_1_cry_7_0_S0, Q0=>baudcounter_7);
    SLICE_6I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   CCU2_INJECT1_0=>"NO", CCU2_INJECT1_1=>"NO", GSR=>"DISABLED", 
                   INIT0_INITVAL=>X"C005", INIT1_INITVAL=>X"C005", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'1', B1=>baudcounter_10, C1=>'1', D1=>'1', 
                DI1=>'X', DI0=>un2_baudcounter_1_cry_9_0_S0, A0=>'1', 
                B0=>baudcounter_9, C0=>'1', D0=>'1', 
                FCI=>un2_baudcounter_1_cry_8, M0=>'X', CE=>'X', CLK=>clk, 
                LSR=>baudcounter11, FCO=>un2_baudcounter_1_cry_10, 
    ...
    SLICE_7I: SCCU2C
      ...
      port map (M1=>'X', A1=>baudcounter_12, B1=>'1', C1=>'1', D1=>'1', 
                ...
                DI0=>un2_baudcounter_1_cry_11_0_S0, A0=>'1', 
                B0=>baudcounter_11, C0=>'1', D0=>'1', 
                FCI=>un2_baudcounter_1_cry_10, M0=>'X', CE=>'X', CLK=>clk, 
                LSR=>baudcounter11, FCO=>un2_baudcounter_1_cry_12, 
    ...
    SLICE_8I: SCCU2C
      ...
      port map (M1=>'X', A1=>baudcounter_14, B1=>'1', C1=>'1', D1=>'1', 
                ...
                DI0=>un2_baudcounter_1_cry_13_0_S0, A0=>'1', 
                B0=>baudcounter_13, C0=>'1', D0=>'1', 
                FCI=>un2_baudcounter_1_cry_12, M0=>'X', CE=>'X', CLK=>clk, 
                LSR=>'X', FCO=>un2_baudcounter_1_cry_14, 
    ...
    SLICE_9I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   ...
                   INIT0_INITVAL=>X"C005", INIT1_INITVAL=>X"C005", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'1', B1=>baudcounter_16, C1=>'1', D1=>'1', 
                DI1=>'X', DI0=>un2_baudcounter_1_cry_15_0_S0, A0=>'1', 
                B0=>baudcounter_15, C0=>'1', D0=>'1', 
    ...
    SLICE_10I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   ...
                   REG1_SD=>"VHI", REG0_SD=>"VHI", CHECK_DI1=>TRUE, 
                   CHECK_DI0=>TRUE, CHECK_LSR=>TRUE)
      port map (M1=>'X', A1=>'1', B1=>baudcounter_18, C1=>'1', D1=>'1', 
                DI1=>un2_baudcounter_1_cry_17_0_S1, 
                DI0=>un2_baudcounter_1_cry_17_0_S0, A0=>'1', 
                B0=>baudcounter_17, C0=>'1', D0=>'1', 
                FCI=>un2_baudcounter_1_cry_16, M0=>'X', CE=>'X', CLK=>clk, 
                LSR=>baudcounter11, FCO=>un2_baudcounter_1_cry_18, 
    ...
    SLICE_11I: SCCU2C
      generic map (CLKMUX=>"SIG", CEMUX=>"VHI", CCU2_INJECT1_0=>"NO", 
                   ...
                   INIT0_INITVAL=>X"C005", INIT1_INITVAL=>X"C005", 
                   REG0_SD=>"VHI", CHECK_DI0=>TRUE)
      port map (M1=>'X', A1=>'1', B1=>baudcounter_20, C1=>'1', D1=>'1', 
                DI1=>'X', DI0=>un2_baudcounter_1_cry_19_0_S0, A0=>'1', 
                B0=>baudcounter_19, C0=>'1', D0=>'1', 
    ...
    SLICE_12I: SCCU2C
      ...
      port map (M1=>'X', A1=>baudcounter_22, B1=>'1', C1=>'1', D1=>'1', 
                DI1=>'X', DI0=>un2_baudcounter_1_cry_21_0_S0, A0=>'1', 
                B0=>baudcounter_21, C0=>'1', D0=>'1', 
    ...
    SLICE_13I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>baudcounter11_14, 
                B1=>baudcounter11_13, C1=>baudcounter11_21, 
                D1=>baudcounter11_20, DI1=>'X', DI0=>baudclock_0, 
                A0=>baudcounter11, B0=>'X', C0=>LED_c_0, D0=>'X', M0=>'X', 
                CE=>'X', CLK=>clk, LSR=>'X', OFX1=>open, F1=>baudcounter11, 
                Q1=>open, OFX0=>open, F0=>baudclock_0, Q0=>LED_c_0);
    SLICE_14I: SLOGICB
      generic map (M1MUX=>"SIG", CLKMUX=>"SIG", CEMUX=>"VHI", LSRMUX=>"SIG", 
                   GSR=>"DISABLED", LUT0_INITVAL=>X"0F0F", REG0_SD=>"VHI", 
      ...
      port map (M1=>un2_baudcounter_1_cry_7_0_S1, FXA=>'X', FXB=>'X', A1=>'X', 
                ...
                A0=>'X', B0=>'X', C0=>baudcounter_0, D0=>'X', M0=>'X', CE=>'X', 
    ...
    SLICE_18I: SLOGICB
      generic map (LUT0_INITVAL=>X"0033", LUT1_INITVAL=>X"1000")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>baudcounter_1, 
                B1=>baudcounter_2, C1=>baudcounter11_16, D1=>baudcounter11_6, 
                DI1=>'X', DI0=>'X', A0=>'X', B0=>baudcounter_4, C0=>'X', 
                D0=>baudcounter_3, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', 
                OFX1=>open, F1=>baudcounter11_20, Q1=>open, OFX0=>open, 
                F0=>baudcounter11_6, Q0=>open);
    SLICE_19I: SLOGICB
      generic map (LUT0_INITVAL=>X"0400", LUT1_INITVAL=>X"0001")
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>baudcounter_14, 
                B1=>baudcounter_19, C1=>baudcounter_13, D1=>baudcounter_15, 
                DI1=>'X', DI0=>'X', A0=>baudcounter_24, B0=>baudcounter11_17, 
                C0=>baudcounter_22, D0=>baudcounter11_12, M0=>'X', CE=>'X', 
    ...
    SLICE_20I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>baudcounter_12, 
                B1=>baudcounter_16, C1=>baudcounter_11, D1=>baudcounter_17, 
                DI1=>'X', DI0=>'X', A0=>baudcounter_23, B0=>baudcounter_18, 
                C0=>baudcounter_21, D0=>baudcounter_20, M0=>'X', CE=>'X', 
    ...
    SLICE_21I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>baudcounter_9, 
                B0=>baudcounter_8, C0=>'X', D0=>baudcounter_0, M0=>'X', 
    ...
    SLICE_22I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>baudcounter_10, 
                B0=>baudcounter_6, C0=>baudcounter_7, D0=>baudcounter_5, 
    ...
    SLICE_23I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                D1=>'X', DI1=>'X', DI0=>'X', A0=>'X', B0=>selectClock_c, 
                C0=>clk12M_c, D0=>osc_clk, M0=>'X', CE=>'X', CLK=>'X', 
    ...
    SLICE_24I: SLOGICB
      ...
      port map (M1=>'X', FXA=>'X', FXB=>'X', A1=>'X', B1=>'X', C1=>'X', 
                ...
                D0=>LED_c_0, M0=>'X', CE=>'X', CLK=>'X', LSR=>'X', OFX1=>open, 
